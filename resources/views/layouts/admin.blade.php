...
<html lang="en">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/chosen.min.css') }}">
        ...
        <link href="{{ asset('dashassets/css/metisMenu.min.css') }}" rel="stylesheet">
        {{-- <link href="../css/metisMenu.min.css" rel="stylesheet"> --}}

        <!-- Timeline CSS -->
        <link href="{{ asset('dashassets/css/timeline.css') }}" rel="stylesheet">
        {{-- <link href="../css/timeline.css" rel="stylesheet"> --}}

        <!-- Custom CSS -->
        <link href="{{ asset('dashassets/css/startmin.css') }}" rel="stylesheet">
        {{-- <link href="../css/startmin.css" rel="stylesheet"> --}}

        <!-- Morris Charts CSS -->
        <link href="{{ asset('dashassets/css/morris.css') }}" rel="stylesheet">
        {{-- <link href="../css/morris.css" rel="stylesheet"> --}}

        <!-- Custom Fonts -->
        <link href="{{ asset('dashassets/css/font-awesome.min.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">SALAMMARKET</a>
                </div>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li><a href="/" target="_blank"><i class="fa fa-home fa-fw"></i> Salammarket.uz</a></li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('admin.dashboard')}}" title="Dashboard" class="active"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            {{-- <li>
                            ...
                            <li>
                                <a href="{{route('admin.categories')}}" title="Categories"><i class="fa fa-th-large fa-fw"></i> Categories</a>
                            </li>
                            <li>
                                <a title="Products" href="{{route('admin.products')}}"><i class="fa fa-cubes fa-fw"></i> Products</a>
                            </li>
                            <li>
                                <a title="Home Slider" href="{{route('admin.homeslider')}}"><i class="fa fa-desktop fa-fw"></i> Home Slider</a>
                            </li>
                            <li>
                                <a title="Home Categories" href="{{route('admin.homecategories')}}"><i class="fa fa-list fa-fw"></i> Home Categories</a>
                            </li>
                            <li>
                                <a title="Sale Setting" href="{{route('admin.sale')}}"><i class="fa fa-tags fa-fw"></i> Sale Setting</a>
                            </li>
                            <li>
                                <a title="Coupon Setting" href="{{route('admin.coupons')}}"><i class="fa fa-hashtag fa-fw"></i>Coupon Setting</a>
                            </li>
                            <li>
                                <a title="All Orders" href="{{route('admin.orders')}}"><i class="fa fa-cart-arrow-down fa-fw"></i> All Orders</a>
                            </li>
                            <li>
                                <a title="Create Order" href="{{route('admin.createorder')}}"><i class="fa fa-cart-plus fa-fw"></i> Create Order</a>
                            </li>
                            <li>
                                <a title="Contact Messages" href="{{route('admin.contact')}}"><i class="fa fa-phone-square fa-fw"></i> Contact Messages</a>
                            </li>
                            <li>
                                <a title="Settings" href="{{route('admin.settings')}}"><i class="fa fa-wrench fa-fw"></i> Settings</a>
                            </li>
                            {{-- <li>
        ...
        <script src="{{ asset('dashassets/js/tables.js') }}"></script> --}}
