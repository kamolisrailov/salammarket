                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="AddProduct">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Product Name" class="form-control imput-md" wire:model="name" wire:keyup="generateSlug"/>
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Regular Price" class="form-control imput-md" wire:model="regular_price"/>
                                    @error('regular_price')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Sale Price" class="form-control imput-md" wire:model="sale_price"/>
                                    @error('sale_price')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="SKU" class="form-control imput-md" wire:model="SKU"/>
                                    @error('SKU')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Quantity" class="form-control imput-md" wire:model="quantity"/>
                                    @error('quantity')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" placeholder="Quantity" class="input-file" wire:model="image"/>
                                    @if ($image)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" placeholder="Quantity" class="input-file" wire:model="images" multiple/>
                                    @if ($images)
