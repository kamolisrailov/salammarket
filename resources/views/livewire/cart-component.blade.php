                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click.event="increaseQuantity('{{$item->rowId}}')"></a>
                                <a class="btn btn-reduce" href="#" wire:click.event="decreaseQuantity('{{$item->rowId}}')"></a>
                            </div>
                            <p class="text-center"><a href="#"  wire:click.event="switchToSaveForLater('{{$item->rowId}}')">Save For Later</a></p>
                        </div>
                        <div class="price-field sub-total"><p class="price">${{$item->subtotal}}</p></div>
                        <div class="delete">
                            <a href="#" class="btn btn-delete" title="" wire:click.event="destroy('{{$item->rowId}}')">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if(Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount{{Session::get('coupon')['code']}} <a href="#"><i class="fa fa-times text-danger" wire:click.preven="removeCoupon"></i></a> </span><b class="index"> -${{number_format($discount,2)}}</b></p>
                        <p class="summary-info"><span class="title">Subtotal with Discount </span><b class="index">${{number_format($subtotlaAfterDiscount,2)}}</b></p>
                        <p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%) </span><b class="index">${{number_format($taxAfterDisount,2)}}</b></p>
                ...
                <div class="checkout-info">
                    ...
                    <label class="checkbox-field">
                        <input class="form-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouponCode"><span>I have promo code</span>
                    </label>
                    @if($haveCouponCode == 1)
                    <div class="summary-item">
                        ...
                        @endif
                            <p class="row-in-form">
                                <label for="coupon-code">Enter your promo code:</label>
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" wire:click.event="destroyAll()" href="#">Clear Shopping Cart</a>
 ...
 //Cart::instance('cart')->destroy();
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center"><a href="#"  wire:click.event="moveToCart('{{$item->rowId}}')">Move To Cart</a></p>
                        </div>

                        <div class="delete">
                            <a href="" class="btn btn-delete" title="" wire:click.event="deleteFromSaveForLate('{{$item->rowId}}')">
                                <span>Delete from your cart</span>
                                <i class="fa fa-times-circle" aria-hidden="true"></i>
                            </a>
                        </div>
                ...
                @else
                <p> No item item saved for later </p>
                @endif
            </div>
